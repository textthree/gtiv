...
const (
	Logic_Connect_FullMethodName     = "/Logic/Connect"
	Logic_Disconnect_FullMethodName  = "/Logic/Disconnect"
	Logic_Heartbeat_FullMethodName   = "/Logic/Heartbeat"
	Logic_RenewOnline_FullMethodName = "/Logic/RenewOnline"
)
