(function(win) {
    ...
    Client.prototype.createConnect = function(max, delay) {
        ...
        function connect() {
            var ws = new WebSocket('ws://192.168.1.200:2005/sub');
            ...
            function auth() {
                var token = '{"room_id":"room_6", "platform":"web", "accepts":[165,6], "userToken":"4173XSkzDnN-TAUwY3gNVGkcK2FRPGBKNTsnZj9dNyM_"}'
                var headerBuf = new ArrayBuffer(rawHeaderLen);
                var headerView = new DataView(headerBuf, 0);
